...
public class AutoFillAspect {
    ...
    private SnowFlakeIdWorker getSnowFlakeIdWorker(JoinPoint joinPoint) {
        ...
        if (methodName.startsWith("cn.aitenry.iims.integral.mapper")) {
            return adminSnowFlakeIdWorker;
        } else if (methodName.startsWith("cn.aitenry.iims.archive.mapper")) {
            return archiveSnowFlakeIdWorker;
        } else if (methodName.startsWith("cn.aitenry.iims.ai.chat.mapper")) {
            return aiSnowFlakeIdWorker;
        } else if (methodName.startsWith("cn.aitenry.iims.common.mapper")) {
