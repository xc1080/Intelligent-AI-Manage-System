package cn.aitenry.iims.auth.utils;
...
public class StpCustomerUtils {
     ...
     * @param loginId 账号id
     */
    public static void takeOffline(Object loginId) {
     ...
     */
    public static void takeOffline(Object loginId, String device) {
     ...
     * @param tokenValue 指定token
     */
    public static void takeOfflineByTokenValue(String tokenValue) {
